...
App = (function(_super) {
  ...
  function App() {
    this.deserializeBounce = __bind(this.deserializeBounce, this);
    this.onSelectPreset = __bind(this.onSelectPreset, this);
    this.playAnimation = __bind(this.playAnimation, this);
...
},{"../easing/bounce":"YYToEi","../easing/hardbounce":"PioQnB","../easing/hardsway":"QP+fRn","../easing/sway":"EwwsAM","../math/matrix4d":"HpNQed"}],"scripts/lib/bounce/components/index":[function(require,module,exports){
...
},{"./index":"Up4a/o"}],"scripts/lib/bounce/easing/hardbounce":[function(require,module,exports){
...
},{"./bounce":"YYToEi"}],"QP+fRn":[function(require,module,exports){
...
},{"jquery":"MtfruI"}],"scripts/lib/jquery.togglebutton":[function(require,module,exports){
...
},{"backbone":"KDJVm1","chosen":"Zvq4H4","icheck":"tL/byK","jquery":"MtfruI","nouislider":"CKvjVX","scripts/lib/jquery.togglebutton":"BFH2vT"}],"scripts/setup":[function(require,module,exports){
module.exports=require('xdNEL6');
},{}],"scripts/urlhandler":[function(require,module,exports){
...
},{"backbone":"KDJVm1"}],"scripts/views/base":[function(require,module,exports){
module.exports=require('/l3mMY');
},{}],"FpVIhp":[function(require,module,exports){
...
var BaseView, Component, Events, template, _,
  __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
Component = (function(_super) {
  ...
  function Component() {
    this.onDebouncedInputChanged = __bind(this.onDebouncedInputChanged, this);
    this.renderInputs = __bind(this.renderInputs, this);
    this.setupInputElements = __bind(this.setupInputElements, this);
  ...
  Component.prototype.setValues = function(component) {
    var input, serialized, _i, _len, _ref;
    serialized = component.serialize();
    _ref = ["type", "easing", "bounces", "duration", "delay", "stiffness"];
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      input = _ref[_i];
...
InputView = (function(_super) {
  ...
  function InputView() {
    this.getInputValue = __bind(this.getInputValue, this);
...
var InputView, RotateInputView, template, _,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
RotateInputView = (function(_super) {
  __extends(RotateInputView, _super);
...
ScaleInputView = (function(_super) {
  __extends(ScaleInputView, _super);
...
},{"./vector":"Azn1fi","templates/inputs/scale":"VloDe9"}],"scripts/views/inputs/scale":[function(require,module,exports){
module.exports=require('gN18R1');
},{}],"NVh/Q+":[function(require,module,exports){
...
SkewInputView = (function(_super) {
  __extends(SkewInputView, _super);
...
TranslateInputView = (function(_super) {
  __extends(TranslateInputView, _super);
...
},{"./vector":"Azn1fi","templates/inputs/translate":"ottZS9"}],"scripts/views/inputs/translate":[function(require,module,exports){
module.exports=require('abfBP3');
},{}],"scripts/views/inputs/vector":[function(require,module,exports){
module.exports=require('Azn1fi');
},{}],"Azn1fi":[function(require,module,exports){
...
VectorInputView = (function(_super) {
  __extends(VectorInputView, _super);
...
PreferencesView = (function(_super) {
  ...
  function PreferencesView() {
    this.clearPreset = __bind(this.clearPreset, this);
    this.onChoosePreset = __bind(this.onChoosePreset, this);
    this.getBounceObject = __bind(this.getBounceObject, this);
    this.checkHeight = __bind(this.checkHeight, this);
    this.setHeight = __bind(this.setHeight, this);
    this.onRemoveComponent = __bind(this.onRemoveComponent, this);
  ...
  PreferencesView.prototype.appendComponent = function(component, options) {
    var componentView, _i, _len, _ref;
    if (options == null) {
      options = {};
    }
  ...
  PreferencesView.prototype.setFromBounceObject = function(bounce) {
    ...
    _ref = bounce.components;
    _results = [];
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      component = _ref[_i];
      _results.push(this.appendComponent(component, {
        collapsed: true,
        silent: true
      }));
    }
...
ShortenView = (function(_super) {
  __extends(ShortenView, _super);
